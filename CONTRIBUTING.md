...
1. Check the [current issues](https://github.com/LandRegistry/ddat-capability-assessment/issues) and [pull requests](https://github.com/LandRegistry/ddat-capability-assessment/pulls) first to see if anyone else is already working on the same bug or feature. If they are, consider contributing to that existing issue or pull request first, rather than duplicating work.
